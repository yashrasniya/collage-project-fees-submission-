...
# # default_app = firebase_admin.credentials.Certificate('Certificate.json')
...
# # db = firestore.client()
# #
# # doc_ref = db.collection('Name').document(u'1')
# # doc_ref.set({
# #     'first': u'Ada',
# #     u'last': u'Lovelace',
# #     u'born': 1815
...
#             )"
# print(City("Beijing", None, "China", True, 21500000, ["hebei"]).to_dict()
# )
import smtplib, ssl
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
  <tr>
    <td style="padding-right: 0px;padding-left: 0px;" align="center">
      ...
      <img align="center" border="0" src="images/image-3.png" alt="Tick Icon" title="Tick Icon" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 14%;max-width: 81.2px;" width="81.2" class="v-src-width v-src-max-width"/>
